...
export const options = {
  ...
  description: 'Paginated list of server roles, members, bots, emojis, stickers, channels, bans, or invites.',
  usage:       'list <roles | members | bots | emojis | stickers | channels | bans | invites>',
  category:    'utility',
  owner:       false,
  cooldown:    5,
};
